...
<div class="container">
 ...
 <p class="center-date"><fmt:formatDate value="${vo.time }" pattern="YYYY-MM"/><br><span class="scnd-font-color"></span></p>        
               ...
               <div class='btns'>
               <input type='button' value='등록' id='btnInsert' onclick="PmgoUrl('/ReleaseInsert')"/>
			<input type='button' value='수정' id='btnUpdate' onclick="PmgoUrl('/ReleaseUpdate')"/>
			<input type='button' value='삭제' id='btnDelete' onclick="PmgoUrl('/ReleaseDelete')"/>
		</div>
      </form>
      </div>
</body>
